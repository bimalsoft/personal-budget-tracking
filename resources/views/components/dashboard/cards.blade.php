<div class="w-full px-6 py-6 mx-auto" xmlns="http://www.w3.org/1999/html">
    <!-- row 1 -->

    @include('components.dashboard.subComponent.row1Cards')

    <!-- cards row 2 -->

    @include('components.dashboard.subComponent.row2Cards')
    <!-- cards row 3 -->
